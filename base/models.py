...
class DiscountStatusCode(models.Model):
    discount_status_code = models.IntegerField(null=True, blank=True)
    discount_status_name = models.CharField(max_length=100, null=True, blank=True)
    ...
    def __str__(self):
        return self.discount_status_name
...
class Product(models.Model):
    ...
    discount_status_code = models.ForeignKey(DiscountStatusCode, on_delete=models.SET_NULL, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    _id = models.AutoField(primary_key=True, editable=False)
