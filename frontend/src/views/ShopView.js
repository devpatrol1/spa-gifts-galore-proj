...
function ShopView() {
	...
	return (
		<div>
			<Container className='shop-banner-bkgrnd my-3' style={{backgroundImage: `url("../images/bkgrnd1.png")`, backgroundSize: 'cover'}}>
...
function CategoryImg({value}) {
    if (value.toString() == 'Facial Skin Care') {
		return <Image fluid className='shop-img' src={'/images/facial-skin-care-img.png'} />;
	  } else if (value.toString()=='Body Oils and Lotions') {
		return <Image fluid className='shop-img' src={'/images/body-oil&lotion-img.png'} />;
	  } else if (value.toString()=='Bath and Shower') {
		return <Image fluid className='shop-img' src={'/images/bath&shower-img.png'} />;
	  } else if (value.toString()=='Body Fragrances') {
		return <Image fluid className='shop-img' src={'/images/body-fragrance-img.png'} />;
	  } else if (value.toString()=='Candles and Home Fragrances') {
		return <Image fluid className='shop-img' src={'/images/candles&home-fragrances-img.png'} />;
	  } else {
		return <Image fluid className='shop-img' src={'/images/gift-shop-img.png'} />;
	  }
}
